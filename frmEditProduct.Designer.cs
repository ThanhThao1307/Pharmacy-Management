...
namespace Pharmacy_Nhom1
{
    partial class frmEditProduct
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblFormTitle.Size = new Size(420, 38);
            lblFormTitle.TabIndex = 1;
            lblFormTitle.Text = "CẬP NHẬT SẢN PHẨM THUỐC";
            // 
            // lblProductCode
            // 
            ...
            txtPrice.Location = new Point(1079, 84);
            ...
            dgvUnits.Columns.AddRange(new DataGridViewColumn[] { ProductUnitId, UnitName, ConversionRate, ImportPrice, Price });
            dgvUnits.Location = new Point(792, 194);
            ...
            dgvUnits.Size = new Size(439, 297);
            ...
            // ConversionRate
            // 
            ConversionRate.DataPropertyName = "DisplayRatio";
            ConversionRate.HeaderText = "Tỷ Lệ Quy Đổi (1 ĐV Sỉ = ? ĐV Lẻ)";
            ...
            ImportPrice.DefaultCellStyle = dataGridViewCellStyle1;
            ImportPrice.HeaderText = "Giá Nhập Sỉ (Tham khảo)";
            ...
            btBrowseImage.Location = new Point(662, 227);
            btBrowseImage.Name = "btBrowseImage";
            btBrowseImage.Size = new Size(90, 34);
            ...
            lblUnitsTitle.Font = new Font("Segoe UI", 12F);
            lblUnitsTitle.Location = new Point(792, 147);
            lblUnitsTitle.Name = "lblUnitsTitle";
            lblUnitsTitle.Size = new Size(546, 32);
            lblUnitsTitle.TabIndex = 32;
            lblUnitsTitle.Text = "Đơn vị sỉ (Từ phiếu Nhập Kho) — Chỉ sửa Giá Bán:";
            // 
            // pnlContent
            // 

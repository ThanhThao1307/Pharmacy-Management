...
namespace Pharmacy_Nhom1
{
    public partial class frmManageSupplier : Form
    {
        ...
        private void btNew_Click(object sender, EventArgs e)
        {
            ...
            {
                mainForm.OpenChildForm(new frmNewSupplier());
            }
            else
            {
                var inputForm = new frmNewSupplier();
        ...
        private void dgvSuppliers_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (columnName == "Edit")
            {
                if (this.MdiParent is frmMain mainForm)
                {
                    mainForm.OpenChildForm(new frmEditSupplier(supplierId));
                }
                else
                {
                    var editForm = new frmEditSupplier(supplierId);

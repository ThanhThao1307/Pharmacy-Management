...
namespace Pharmacy_Nhom1
{
    public partial class frmManageCustomer : Form
    {
        ...
        private void btNew_Click(object sender, EventArgs e)
        {
            ...
            {
                mainForm.OpenChildForm(new frmNewCustomer());
            }
            else
            {
                var inputForm = new frmNewCustomer();
        ...
        private void dgvCustomers_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "colEdit")
            {
                if (this.MdiParent is frmMain mainForm)
                {
                    mainForm.OpenChildForm(new frmEditCustomer(customerId));
                }
                else
                {
                    var editForm = new frmEditCustomer(customerId);
